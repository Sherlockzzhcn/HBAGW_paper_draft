...
\end{minipage}
    ...
    included in the inference. Figure settings are similar to those in
    figure~\ref{corner2-d} and figure~\ref{2-d_Love_Q}. \LS{[LS: use larger
    fonts; use ``$10^3 d_5$'' instead of ``$d_5/10^{-3}$'', same for $e_5$]}
    } \label{5-d_Love_Q} 
\end{figure}
%---------------------------------------------------------------------
