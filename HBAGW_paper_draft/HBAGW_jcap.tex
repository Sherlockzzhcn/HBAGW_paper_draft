...
uniformly picked in the logarithmic space from the Yagi-Yunes relation ($a_2=$
and $b_2=$ \LS{[LS: add values]}).  As an example of a typical EOS, we plot the
...
differences in $\ln Q$ between these two models and the APR4 EOS are smaller
than $1\%$. 
