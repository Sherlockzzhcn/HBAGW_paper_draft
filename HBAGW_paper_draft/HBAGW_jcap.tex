...
\Revise{Despite this, such a selection of events can still introduce biases in the inference of the Love-Q relation, 
and we make a discussion on this issue in appendix~\ref{sec: appendix biases}.}
...
these results are summarized in appendix~\ref{sec: appendix results for SLy}.}
...
\section{Biases from Limited Number of Events}
\label{sec: appendix biases}
%=============================

In section~\ref{subsec:simulation_implementation}, we have mentioned selecting the loudest 20 events from the 1000 simulated events to perform the inference.
Here we give a more detailed discussion on the biases brought by such selection. 
We performed various tests to understand the dependence of our results on $N_{\text{events}}$.
