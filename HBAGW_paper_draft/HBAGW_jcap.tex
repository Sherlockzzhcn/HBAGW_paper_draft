...
\Revise{Future next-generation (XG) ground-based GW detectors, including the Cosmic
...
\Revise{Yagi and Yunes~\cite{Yagi:2013bca, Yagi:2013awa, Yagi_2017} fit the Love-Q
...
\Revise{The EOS parameters, which determine the $\Lambda$-$m$ and $Q$-$m$ relations,
...
\end{equation}
%--
\Revise{We treat the tidal deformabilities, $\bm{\Lambda}_i=\{\Lambda_{1i},\Lambda_{2i}\}$, 
...
$\chi_1$ and $\chi_2$, the luminosity distance $D_L$, \Revise{the coalescence time $t_{c}$},
...
with mass $m_2$.  \Revise{The tidal deformability and quadrupole moments of the binary
...
\Revise{The current locations of LIGO and Virgo are chosen as an illustrated configuration for XG detectors.}
...
largest $|\chi_{\mathrm{r}}|$ among them. \Revise{The SNR values of these selected events range from about 1500 to 2500.}
\Revise{Here we omit the selection effects 
...
\Revise{For other parameterizations beyond polynomial models, our methodology is in principle applicable to them as well.}
...
\begin{figure}[t]
    ...
    \Revise{The orange bands represent the reference values with fitting uncertainties accounted for.} The grey lines
...
$\beta$ \Revise{are} taken to be dimensionless, so $\alpha$ has the dimension of length
\Revise{squared}, and the quantity $\xi_{\mathrm{CS}}^{1/4} \equiv [\alpha^2/
...
waveform~\cite{Williamson:2017evr, Purrer:2019jcp, Gamba:2020wgg}. \Revise{The inaccuracy of 
...
Wang:2023ldq, Johnson:2024foj, Wang:2025ckw}.  \Revise{Moreover, the Yagi-Yunes
...
\Revise{We thank the anonymous referee for helpful comments.}
