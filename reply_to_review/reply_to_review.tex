...
\begin{authorresponse}
    ...
    We have added a clarification on this in section 6 at page 14 as a possible extension as follows
    ...
    \ZZH{What does ``introducing the calculation'' mean? Currently I've revised the extension part.}
...
\begin{authorresponse}
    ...
    for various EOSs. In this case, should I show results of the two EOSs in the same figure?}
\end{authorresponse}
