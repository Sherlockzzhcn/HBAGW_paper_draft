...
\begin{authorresponse}
    ...
    that biases introduced by universal relations do exist for rapidly rotating systems. Such cases where no universal relations exist are the
    ...
    reference and an estimation for order of magnitude. 
    ...
    \begin{revisedtext}
        ...
        still applies with appropriate model parameterizations and modifications.''
    \end{revisedtext}
    ...
    \begin{revisedtext}
        ``Moreover, the Yagi-Yunes
        universal relations were originally found and discussed for a single NS under slow-rotation assumption. 
        For BNS systems or high spin cases, these universal relations may break down and new relations could emerge. 
        Our methodology works when new universal relations do exist, but still a careful inspection is required~[1, 107-113].''
    \end{revisedtext}
...
\begin{authorresponse}
    ...
    equation of state under slow rotation approximation. We've revised our manuscript (Page 6) from 
    \begin{originaltext}
