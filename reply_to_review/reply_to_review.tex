...
\begin{authorresponse}
    ...
    \ZW{Btw, Tim group's work may serve as a useful ref: https://arxiv.org/pdf/2602.14659}
\end{authorresponse}
...
\begin{authorresponse}
    ...
    \ZW{Btw, Tim group's recent work may serve as a useful ref:
    \href{https://arxiv.org/pdf/2602.14659}{link} maybe add to the discussion as well.}
\end{authorresponse}
...
\begin{authorresponse}
    ...
    parameterization in the hierarchical inference\ZW{Plz add some refs such as
    Lackey2015, Wang2024}, where the implementation and formulas have no essential difference with our case.
...
\begin{authorresponse}
    ...
    \ZW{Maybe add a sentence in the manuscript to clarify this point, like ``We assume the current locations of LIGO and Virgo as a representative configuration for XG detectors.''}
\end{authorresponse}
...
\begin{authorresponse}
    In our study, the highest SNR values range from about 1500 to 2500. The
    sources have luminosity distances near the lower bound 15 Mpc.
    \ZW{Similarly, it would be better to add a sentence in the manuscript to
    clarify this point, like ``The SNR values of the selected events range from
    about 1500 to 2500.'' In addition, I'm not sure stating the luminosity
    distance is necessary, since a natural question is what about different
    lower bounds. Maybe we can just say these events roughly correspond to the
    nearest events.}
\end{authorresponse}
...
\ZW{Can you create some hyperlinks that allow the editor and the reviewer to
easily open the references?}
