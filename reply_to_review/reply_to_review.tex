...
\begin{authorresponse}
    ...
    However, we agree with the reviewer that including the
    selection effect in the inference is a more rigorous approach, 
    and we leave it for future work. We add a sentence at the end of section 3 (the end of page 7) 
    ...
    \begin{revisedtext}
        ...
        significant change of SNR and thus the detection probability. And as we will show in
        section 4, the primary information for constraining the Love-Q
...
\begin{authorresponse}
    ...
    For the number of considered events, we have shown the results for more than 20 events in figure~\ref{fig:a_b_n}
    ...
    describing figure~2, we rewrite 
    \begin{originaltext}
