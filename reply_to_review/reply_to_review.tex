...
\begin{authorresponse}
    ...
    in figure~3 of the manuscript) converge to a stable value. 
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{fig_2d\_model\_n\_changing.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{fig_width\_n\_changing.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{fig_snr\_Q\_spin.pdf}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.5\textwidth]{fig_comparison\_corner\_plot.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{fig_hierarchical\_results\_SLy\_2d.pdf}
